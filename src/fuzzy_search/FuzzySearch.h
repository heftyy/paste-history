...
namespace FuzzySearch
{
	...
	int CalculateScore(const std::string& pattern, const std::string& str, int pattern_index, int str_index, int filename_start_index, 
					   MatchMode match_mode, const std::vector<int>& matches, int matches_length);
